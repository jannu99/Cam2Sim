...
def generate_control_dicts() -> List[ControlDict]:
    control_dicts: List[ControlDict] = [
        ...
        #SEG INS TEMP
        {
            'start': [0.11, 0.00, 0.00],
            'end': [1.00, 0.10, 0.10]
        },
        {
            'start': [0.21, 0.00, 0.00],
            'end': [1.00, 0.20, 0.20]
        },
        {
            'start': [0.31, 0.00, 0.00],
            'end': [1.00, 0.30, 0.30]
        },
        {
            'start': [0.41, 0.00, 0.00],
            'end': [1.00, 0.40, 0.40]
        },
        {
            'start': [0.11, 0.11, 0.00],
            'end': [1.00, 1.00, 0.10]
        },
        {
            'start': [0.21, 0.21, 0.00],
            'end': [1.00, 1.00, 0.20]
        },
        {
            'start': [0.31, 0.31, 0.00],
            'end': [1.00, 1.00, 0.30]
        },
        {
            'start': [0.41, 0.41, 0.00],
            'end': [1.00, 1.00, 0.40]
        },
        {
            'start': [0.11, 0.21, 0.00],
            'end': [0.20, 1.00, 0.10]
        },
        {
            'start': [0.21, 0.31, 0.00],
            'end': [0.30, 1.00, 0.20]
        },
        {
            'start': [0.31, 0.41, 0.00],
            'end': [0.40, 1.00, 0.30]
        },
        {
            'start': [0.41, 0.51, 0.00],
            'end': [0.50, 1.00, 0.40]
        },
        {
            'start': [0.11, 0.31, 0.00],
            'end': [0.30, 1.00, 0.10]
        },
        {
            'start': [0.21, 0.41, 0.00],
            'end': [0.40, 1.00, 0.20]
        },
        {
            'start': [0.31, 0.51, 0.00],
            'end': [0.50, 1.00, 0.30]
        },
        {
            'start': [0.41, 0.61, 0.00],
            'end': [0.60, 1.00, 0.40]
        },
        {
            'start': [0.11, 0.41, 0.00],
            'end': [0.40, 1.00, 0.10]
        },
        {
            'start': [0.21, 0.51, 0.00],
            'end': [0.50, 1.00, 0.20]
        },
        {
            'start': [0.31, 0.61, 0.00],
            'end': [0.60, 1.00, 0.30]
        },
        {
            'start': [0.41, 0.71, 0.00],
            'end': [0.70, 1.00, 0.40]
        },
        {
            'start': [0.11, 0.51, 0.00],
            'end': [0.50, 1.00, 0.10]
        },
        {
            'start': [0.21, 0.61, 0.00],
            'end': [0.60, 1.00, 0.20]
        },
        {
            'start': [0.31, 0.71, 0.00],
            'end': [0.70, 1.00, 0.30]
        },
        {
            'start': [0.41, 0.81, 0.00],
            'end': [0.80, 1.00, 0.40]
        },
        {
            'start': [0.11, 0.61, 0.00],
            'end': [0.60, 1.00, 0.10]
        },
        {
            'start': [0.21, 0.71, 0.00],
            'end': [0.70, 1.00, 0.20]
        },
        {
            'start': [0.31, 0.81, 0.00],
            'end': [0.80, 1.00, 0.30]
        },
        {
            'start': [0.41, 0.91, 0.00],
            'end': [0.90, 1.00, 0.40]
        },
...
def main():
    ...
    for d in final_control_dicts:
        print(d)
    output_dir_main = f"./offline_outputs_test_best"
    os.makedirs(output_dir_main, exist_ok=True)
    for caption in [False]:
            ...
            for control_dict in final_control_dicts:
                ...
                output_dir = f"./offline_outputs_test_best/CAPTIONING_{caption}__CONDITIONING_seg_{condscale_seg}_inst_{condscale_inst}_temp_{condscale_temporal}__SPLITSTART_seg_{control_guidance_start[0]}_inst_{control_guidance_start[1]}_temp_{control_guidance_start[2]}__SPLITEND_seg_{control_guidance_end[0]}_inst_{control_guidance_end[1]}_temp_{control_guidance_end[2]}"
